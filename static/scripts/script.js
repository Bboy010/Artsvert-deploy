...
(function () {
	...
	$window.on('load', function () {
		...
		// Écoute de l'événement popstate pour gérer le bouton "Back"
		// window.addEventListener('popstate', function (event) {
		// 	// Déclencher le comportement du préchargeur lors du retour avec le bouton "Back"
		// 	if (plugins.preloader.length && !isNoviBuilder) {
		// 		plugins.preloader.removeClass('loaded');
		// 	}
		// });
	...
	$(function () {
		...
		function attachFormValidator(elements) {
			...
			var regularConstraintsMessages = [
				...
				// {
				// 	type: regula.Constraint.Choosen,
				// 	newMessage: "Please choose a png or jpeg file"
				// }
			];
